  ...
  return (
    <div onClick={() => navigate(link)}>
      ...
      >
        ...
        ></motion.div>
        <p className="text-white absolute bottom-[65px] md:bottom-[80px] lg:bottom-[95px] left-[20px] md:left-[30px] font-bold text-[28px] md:text-[30px] lg:text-[37px] leading-[34px] lg:leading-[45px] max-w-[300px] lg:max-w-[410px] z-10">
          {projectName}
        </p>
        <motion.p
          animate={{
          ...
          className="text-white absolute bottom-[10px] md:bottom-[20px] left-[20px] md:left-[30px] font-bold text-[20px] md:text-[25px] max-w-[420px] z-10 flex items-center"
        >
          VIEW PROJECT{" "}
          <motion.img
            animate={{
